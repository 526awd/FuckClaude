...
export const ui = {
  en: {
    ...
    'credit.deepseek': 'Modified by Deepseek-v4 model',
    'credit.mimo': 'Beautified by MiMo model',
  ...
  zh: {
    ...
    'credit.deepseek': '由Deepseek-v4模型修改',
    'credit.mimo': '由MiMo模型修改美化',
  ...
  ja: {
    ...
    'credit.deepseek': 'Deepseek-v4モデルで修正',
    'credit.mimo': 'MiMoモデルで美化',
  ...
  ko: {
    ...
    'credit.deepseek': 'Deepseek-v4 모델로 수정',
    'credit.mimo': 'MiMo 모델로美化',
  ...
  fr: {
    ...
    'credit.deepseek': 'Modifié par le modèle Deepseek-v4',
    'credit.mimo': 'Embelli par le modèle MiMo',
  ...
  de: {
    ...
    'credit.deepseek': 'Ändert mit Deepseek-v4 Modell',
    'credit.mimo': 'Verschönert mit MiMo Modell',
  ...
  es: {
    ...
    'credit.deepseek': 'Modificado con el modelo Deepseek-v4',
    'credit.mimo': 'Embellecido con el modelo MiMo',
  ...
  pt: {
    ...
    'credit.deepseek': 'Modificado com o modelo Deepseek-v4',
    'credit.mimo': 'Embelezado com o modelo MiMo',
  ...
  ru: {
    ...
    'credit.deepseek': 'Изменено с моделью Deepseek-v4',
    'credit.mimo': 'Улучшено с моделью MiMo',
  ...
  ar: {
    ...
    'credit.deepseek': 'تم التعديل بواسطة نموذج Deepseek-v4',
    'credit.mimo': 'تم التجميل بواسطة نموذج MiMo',
  ...
  hi: {
    ...
    'credit.deepseek': 'Deepseek-v4 मॉडल द्वारा संशोधित',
    'credit.mimo': 'MiMo मॉडल द्वारा सुंदर बनाया गया',
  ...
  it: {
    ...
    'credit.deepseek': 'Modificato con il modello Deepseek-v4',
    'credit.mimo': 'Abbellito con il modello MiMo',
  ...
  nl: {
    ...
    'credit.deepseek': 'Gewijzigd met Deepseek-v4 model',
    'credit.mimo': 'Verfraaid met MiMo model',
  ...
  pl: {
    ...
    'credit.deepseek': 'Zmodyfikowane modelem Deepseek-v4',
    'credit.mimo': 'Upiększone modelem MiMo',
  ...
  tr: {
    ...
    'credit.deepseek': 'Deepseek-v4 modeli ile değiştirildi',
    'credit.mimo': 'MiMo modeli ile güzelleştirildi',
  ...
  vi: {
    ...
    'credit.deepseek': 'Được sửa đổi bởi mô hình Deepseek-v4',
    'credit.mimo': 'Được làm đẹp bởi mô hình MiMo',
  ...
  th: {
    ...
    'credit.deepseek': 'แก้ไขด้วยโมเดล Deepseek-v4',
    'credit.mimo': 'ทำให้สวยงามด้วยโมเดล MiMo',
  ...
  id: {
    ...
    'credit.deepseek': 'Dimodifikasi dengan model Deepseek-v4',
    'credit.mimo': 'Dipercantik dengan model MiMo',
